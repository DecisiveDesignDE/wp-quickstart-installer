...
class Step06(tk.Frame):
    def __init__(self, parent, controller):
        ...
        steps = [
            ...
            "Check Github for any further questions."
        ]
        ...
        # Thank You Message
        thank_you_label = tk.Label(self, text="Thanks for using WP Quickstart", font=("Arial", 12, "bold"), bg="#f4f4f4")
        thank_you_label.pack(pady=(20, 10))

        # Close Button
        close_button = ttk.Button(self, text="CLOSE", command=self.finish_setup, style="Bold.TButton")
