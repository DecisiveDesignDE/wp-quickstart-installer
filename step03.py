...
class Step03(tk.Frame):
    def __init__(self, parent, controller):
        ...
        def resource_path(relative_path):
            ...
            print(f"Resolving path: {full_path}")  # Debug print statement
            return full_path
        ...
        def create_checkbox_with_icon(parent, name, var, row, column, icon_path):
            ...
            img = Image.open(resource_path(icon_path)).resize((30, 30))
            ...
            info_img = Image.open(resource_path("img/question.png")).resize((15, 15))
    ...
    def prev_window(self):
        self.controller.show_frame("Step02")
